 ...
 * @file     can_user.c
 * @version  V2.00
 * @brief    M0A21 series CAN driver source file
 *
...
/**
  ...
  * @retval TRUE Receive a message success.
  *
  */
...
/**
  ...
  * @param[in] pCanMsg Pointer to the message structure where received data is copied.
  *
  * @retval FALSE When operation in basic mode: Transmit message time out. \n
  *               When operation in normal mode: No useful interface. \n
